...
public class Intro_WebHit_POST_FarmFarmPop_GetByFarmID {
    ...
    public void getFarmPop(Context context, final IWebCallback iWebCallback, int id) {
        ...
        mContext = context;
//        String myUrl = AppConfig.getInstance().getBaseUrlApi() + ApiMethod.POST.getFarmPopbyFarmID + "?FarmerID=" + id;
        String myUrl = "http://74.208.144.99:9090/api/FarmerFarmPopulation/GetByFarmID?FarmerID=" + id;
