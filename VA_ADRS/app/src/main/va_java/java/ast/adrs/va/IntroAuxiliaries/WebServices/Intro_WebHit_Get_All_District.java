...
public class Intro_WebHit_Get_All_District {

    public static ResponseModel responseObject = null;
    private final AsyncHttpClient mClient = new AsyncHttpClient();

    public void getDistrict(final IWebCallback iWebCallback) {

        String myUrl;


        myUrl = AppConfig.getInstance().getBaseUrlApi() + ApiMethod.POST.getDistrict;
//        myUrl = "http://74.208.144.99:9090/api/FlatMouza/GetAllDistrict";

        Log.d("LOG_AS", "getDistrict: " + myUrl);
